...
let DeliveryController = class DeliveryController {
    ...
    async findByTransaction(transactionId) {
        ...
        if (!delivery)
            throw new common_1.NotFoundException('No delivery found for transaction ' + transactionId);
...
exports.DeliveryController = DeliveryController = __decorate([
    ...
    __metadata("design:paramtypes", [delivery_repository_port_1.DeliveryRepositoryPort])
], DeliveryController);
